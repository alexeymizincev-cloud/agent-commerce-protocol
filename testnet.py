...
async def run_testnet():
    ...
    # Step 4: Provider discovers request
    print("[STEP 4] Provider discovers Request via relay")
    requests_found = await provider_client.get_events(
    ...
    # Step 6: Consumer discovers Offer
    print("[STEP 6] Consumer discovers Offer via relay")
    offers_found = await consumer_client.get_events(
    ...
    # Step 9: Consumer discovers Receipt + decrypts
    print("[STEP 9] Consumer discovers Receipt via relay + decrypts")
    receipts_found = await consumer_client.get_events(
    ...
    # Summary
    print("=" * 60)
    print("  TESTNET TRANSACTION COMPLETE")
    print("=" * 60)
